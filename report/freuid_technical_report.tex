...
\author{%
  Michael Semenoff\\
  \small
  [TODO: Affiliation --- leave blank/independent if not applicable]\\
  \texttt{\contactemail}
}
...
\textbf{Code:} \url{https://github.com/msemenoff/freuid-challenge-2026} (commit \texttt{683b274aae00078d2dd5a93c81c7a8c6ba60c9f4})\\
...
\begin{itemize}[noitemsep]
  ...
  commit \texttt{683b274aae00078d2dd5a93c81c7a8c6ba60c9f4} (verified: the
  Git LFS-tracked checkpoint's SHA-256 on the remote matches
  \texttt{models/README.md}). This SHA reflects the code/weights state at the
  time of writing; if the private-test-inference-only commits described below
  are added after July 13, this section will be updated to point at the
  final frozen commit while confirming model weights are unchanged.
